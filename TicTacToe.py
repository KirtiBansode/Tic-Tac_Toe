...
# Play in a terminal by typing 'python3 TicTacToe.py'.
...
print(20*' ','  1  | 2  | 3    ')
print(20*' ',"-----+----+----- ")
print(20*' ',"     |    |      ")#printing reference board for help to see indices
print(20*' ',"  4  | 5  | 6    ")
print(20*' ',"-----+----+----- ")
print(20*' ',"     |    |      ")
print(20*' ',"  7  | 8  | 9    \n")
...
def human_input(mark):   #function for taking human input
    while True:
        ...
        if inp.isdigit() and int(inp) <10 and int(inp) >0:
            ...
            if board[inp] == " ":
                ...
                print(f"[HUMAN] '{mark}' place already taken.")#if box is already filled
        else:
            print(f"[HUMAN] '{mark}' Enter valid option (1 - 9).")#print to enter user input


def winning(mark,board): #mentioning 8 winning conditions
...
def cpu_input(cpu , human , board):  #computer move function
    for i in range(1,10):
...
def user_choice(): #function to choose mark i.e 'x' or 'o' if user choose 'x' the first turn
    while True:    #will be of user otherwise user will play 2nd
